...
Настольный клиент AmneziaVPN хорош для личного использования. Amnezia Control — для случая, когда у вас **несколько нод на команду** и управлять ими вручную перестаёт масштабироваться.
...
> Независимый open-source-проект, не связан с AmneziaVPN и не является официальным продуктом.
